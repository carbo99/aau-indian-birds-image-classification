...
# Traccia gradienti e pesi del modello su W&B
...
for epoch in range(config.epochs):
    ...
    if val_acc > best_val_acc:
        ...
        # Checkpoint save on W&B
        wandb.save("best_model.pth")

print(f"\nTraining completed. Best Val Acc: {best_val_acc:.4f}")

# =====================
# GRAPH: LOSS, ACCURACY, LR  (saved also on W&B)
# =====================
...
plt.xlabel("Predictions"); plt.ylabel("Actual values")
